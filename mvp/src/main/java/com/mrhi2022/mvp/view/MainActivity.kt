...
// MVP의 장점
//1. MVC처럼 데이터를 제어하는 코드가 Activity/Fragment 클래스안에 없어서 간결하고 어디서든 재사용 가능함
//2. Activity를 view 역할로만 사용하기에 보다 명확하게 역할 구분이 됨.
...
// MVP의 단점
//1. interface를 만들고 class 를 구현하여야 하기에 기본적으로 파일들이 많아져서 복잡해 보임. 처음 학습과정이 어려움.
//2. view 와 presenter가 1:1로 대응되어 있어서 View 역할 클래스가 많아지면 Presenter 파일도 많아짐.
